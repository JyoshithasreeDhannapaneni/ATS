...
if (!extension_loaded('pdo_mysql') || !function_exists('session_start'))
{
    die('OpenCATS Error: Either PHP Sessions extension or PDO MySQL extension (pdo_mysql) is not loaded.');
}
