...
<?php TemplateUtility::printTabs($this->active, $this->subActive); ?>
    <div id="main">
        ...
        <div id="contents">
            ...
            <table class="searchTable" id="searchTable" style="width: 100%;">
                <tr>
                    <td>
                        <form name="searchForm" id="searchForm" action="<?php echo(CATSUtility::getIndexName()); ?>" method="get" autocomplete="off" style="width: 100%;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 12px; width: 100%;">
                                ...
                                <div style="display: flex; align-items: center; gap: 8px; flex: 1; min-width: 200px;">
                                    <input type="text" class="inputbox" id="searchText" name="wildCardString" value="<?php if (!empty($this->wildCardString)) echo(urldecode($this->wildCardString)); ?>" style="flex: 1; min-width: 150px;" />&nbsp;*
            ...
            <?php if ($this->isResultsMode): ?>
                ...
                <?php if (!empty($this->rs)): ?>
                    ...
                    <div style="width: 100%; overflow-x: auto;">
                        <table class="sortable" style="width: 100%; min-width: 600px;" onmouseover="javascript:trackTableHighlight(event)">
                            <tr>
                                <th style="width: 60px;">
                                </th>
                                <th align="left">
                            ...
                            <?php foreach ($this->rs as $rowNumber => $data): ?>
                                <tr class="<?php TemplateUtility::printAlternatingRowClass($rowNumber); ?>">
                                    ...
                                    <td valign="top" align="left"><?php $this->_($data['phone1']); ?></td>
                                    <td valign="top" align="left"><?php $this->_($data['keyTechnologies']); ?></td>
                                    <td valign="top" align="left"><?php $this->_($data['dateCreated']); ?></td>
                                    <td valign="top" align="left"><?php $this->_($data['ownerAbbrName']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                    </div>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; margin-top: 12px;">
                        <div><?php echo($this->exportForm['menu']); ?></div>
                        <div><?php $this->pager->printNavigation('name'); ?></div>
                    </div>
                <?php else: ?>
