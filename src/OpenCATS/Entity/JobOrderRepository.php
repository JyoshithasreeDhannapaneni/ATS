...
class JobOrderRepository
{
    ...
    function persist(JobOrder $jobOrder, \History $history)
    {
        ...
        $sql = sprintf(
            ...
            $this->databaseConnection->makeQueryString($jobOrder->getContactPhone()),
            ...
            $jobOrder->getPipelineTemplateId() !== null ? $this->databaseConnection->makeQueryInteger($jobOrder->getPipelineTemplateId()) : 'NULL',
